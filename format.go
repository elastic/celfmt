...
func (un *formatter) visitSelectInternal(operand ast.Expr, testOnly bool, op string, field string) error {
...
func (un *formatter) writeOperatorWithWrapping(fun string, unmangled string) bool {
